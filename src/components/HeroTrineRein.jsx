...
import TRHeroDesktop from '../images/profiles/TR-desktop-updated.webp';
import TRHeroMobile from '../images/profiles/TR-mobile-updated.webp';

export function HeroTrineRein() {
  return (
      ...
      <div className="relative grid grid-cols-1 overflow-hidden isolate pt-14 sm:grid-cols-2">
        ...
        <div className="max-w-md py-32 pr-6 mx-auto sm:mr-12 sm:-ml-12 sm:col-start-2 sm:max-w-2xl md:max-w-3xl sm:py-48 lg:py-56 sm:mx-0">
          <div className="pt-10 -mb-10 text-center sm:-mb-10 sm:pt-0 sm:text-left">
            <h6 className="pt-24 mt-10 -mb-10 text-5xl text-slate-800 sm:-mb-0 sm:mt-0 sm:pt-20 sm:text-6xl lg:text-7xl">
              Trine Rein
            </h6>
            ...
            >
              Sanger med over 35 års erfaring fra scener verden over.
            </motion.p>
            ...
            <div className="flex items-center justify-center mt-10 sm:justify-start gap-x-6">
              ...
              <Link
                href="/artister"
                className="hidden text-sm font-semibold leading-6 transition-all duration-150 ease-in-out text-slate-500 hover:text-slate-600 sm:block"
              >
