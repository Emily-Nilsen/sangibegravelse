...
import PetterHeroDesktop from '../images/profiles/PV-desktop_v2.webp';
import PetterHeroMobile from '../images/profiles/PV-mobile.webp';

export function HeroPetterVermeli() {
  return (
    <div className="bg-slate-800">
      <div className="relative grid grid-cols-1 overflow-hidden isolate pt-14 sm:grid-cols-2">
        <Image
          src={PetterHeroMobile}
          alt="Petter Vermeli"
          width={900}
          height={1125}
          placeholder="blur"
        ...
        <div className="max-w-md py-32 pr-6 mx-auto sm:mr-12 sm:-ml-12 sm:col-start-2 sm:max-w-2xl md:max-w-3xl sm:py-48 lg:py-56 sm:mx-0">
          <div className="pt-10 -mb-10 text-center sm:-mb-10 sm:pt-0 sm:text-left">
            ...
            >
              Erfaren skuespiller og sanger med et bredt spekter av musikalske
              uttrykk.
            </motion.p>
