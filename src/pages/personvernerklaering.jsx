...
export default function Personvernerklæring() {
  return (
    <>
      <Head>
        <title>
          Personvernerklæring – Dine opplysninger hos Sang i begravelse
        </title>
        <meta
          name="description"
          content="Vår personvernerklæring for nettkontakt hos Sang i begravelse. Les om hvordan vi beskytter og bruker dine opplysninger."
        />
        <link
          rel="canonical"
      ...
      <div className="px-6 py-32 bg-white lg:px-8">
        <div className="max-w-3xl mx-auto text-base leading-7 text-gray-700">
          ...
          <p className="mt-6 text-xl leading-8">
            ...
            forklarer hvordan ‘Sang i begravelse’ samler inn, bruker, beskytter
            og deler informasjon som samles inn gjennom nettkontaktskjemaet.
          </p>
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-6 ">
              Når du sender inn informasjon gjennom nettkontaktskjemaet på ‘Sang
              i begravelse’, kan vi samle inn følgende typer informasjon:
            </p>
            ...
            <ul role="list" className="max-w-xl mt-8 space-y-8 text-gray-600">
              ...
              <li className="flex gap-x-3">
                ...
                <span>
                  ...
                  Vi bruker meldingsinnholdet for å gi deg relevant informasjon
                  og assistanse i forbindelse med våre tjenester.
                </span>
              </li>
            </ul>
            <h2 className="mt-16 text-2xl font-bold tracking-tight text-gray-900">
            ...
            <p className="mt-6">
              Vi lagrer informasjonen du sender inn gjennom nettkontaktskjemaet
              så lenge det er nødvendig for å håndtere dine henvendelser og gi
              deg relevant kundeservice. Etter dette kan vi lagre informasjonen
            ...
            <p className="mt-6">
              Du har rett til å be om innsyn i den informasjonen vi har samlet
              inn om deg gjennom nettkontaktskjemaet, samt rett til å be om
              retting, sletting eller begrensning av bruken av denne
              informasjonen. Du har også rett til å trekke tilbake eventuelle
