  ...
  return (
    <section className="relative bg-white">
      <div className="absolute inset-0 hidden md:block">
        <Image
          src="https://res.cloudinary.com/dt3k2apqd/image/upload/q_auto/Sang%20i%20begravelse/flowers_uwdxba.png"
          alt="Blomster"
      ...
      <div className="absolute inset-0 md:hidden">
        <Image
          src="https://res.cloudinary.com/dt3k2apqd/image/upload/v1687362209/Sang%20i%20begravelse/flowers_uwdxba.png"
          alt="Blomster"
      ...
      <div className="px-6 py-24 bg-t isolate sm:py-32 lg:px-8">
        ...
        >
          <div
            className="relative left-2/3 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[20deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-10 sm:left-[calc(95%-40rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
